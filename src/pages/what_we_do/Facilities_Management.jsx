  ...
  const facilitiesCategories = [
    {
      ...
      description: "Comprehensive HVAC and electrical installation, maintenance, and repair services for industrial facilities, ensuring optimal system performance and energy efficiency.",
      features: [
      ...
      detailedContent: {
        overview: "Calaya Engineering Services is able to provide a complete and comprehensive range of solutions for clients wishing to improve their facilities' operational efficiency or increase the lifespan of their current fleet. At Calaya Engineering Service Limited, we work hard to meet our client's demands by hiring only highly qualified technicians and providing excellent air conditioning services. We are proud to meet the AC installation, maintenance, and repair needs of residential and commercial clients throughout Nigeria.",
        services: [
          { title: "Direct Expansion Systems", description: "Direct expansion and chilled water central cooling systems for comfort and process needs, ensuring optimal temperature control and energy efficiency." },
          { title: "Precision Air Cooling", description: "Precision air cooling (PAC) systems for critical applications requiring exact temperature and humidity control." },
          { title: "Dehumidifier Systems", description: "Advanced dehumidifier systems to control moisture levels and maintain optimal environmental conditions." },
          { title: "Ventilation Duct Work", description: "Professional installation and maintenance of ventilation duct work including both rigid and flexible systems." },
        ],
        benefits: [
    ...
    },
    {
      ...
      description: "Professional surface preparation and coating services using advanced grit and hydro blasting techniques to ensure optimal adhesion and long-lasting protection.",
      features: [
      ...
      detailedContent: {
        overview: "Grit & Hydro Blasting and Coating are corrosion control activities aimed at checking and restoring the integrity of facilities and equipment to pre-defined standards or specifications. We provide a diverse suite of services to address virtually any surface treatment and protection challenge. From surface treatment and coating in the harshest operating environments to ensuring the safety of your workforce against a potential disaster. We have developed a reputation for high quality and excellent service in the surface preparation and protective coatings industry.",
        services: [
          { title: "Surface Preparation", description: "Professional surface preparation services to ensure optimal adhesion and long-lasting protection for industrial equipment and structures in the harshest operating environments." },
          { title: "Blasting", description: "Advanced grit and hydro blasting services for corrosion control activities, checking and restoring the integrity of facilities and equipment to pre-defined standards or specifications." },
          { title: "Painting", description: "High-quality protective coating and painting services to ensure workforce safety against potential disasters and maintain equipment integrity in challenging environments." },
          { title: "Quality Assurance", description: "Comprehensive quality control and inspection services to ensure all surface treatment and protection work meets the highest industry standards and client specifications." },
        ],
        benefits: [
    ...
    },
    {
      ...
      description: "Specialized cleaning services for tanks, test separators, pipelines, and platform equipment to ensure optimal performance and regulatory compliance.",
      features: [
      ...
      detailedContent: {
        overview: "Calaya's Expert Tank Cleaning service team specializes in Cleaning Tanks, Vessels and more. You can count on our highly-skilled personnel and technically advanced equipment to clean your tank or vessel safely and efficiently while exceeding your expectations and maintaining regulatory compliance. We are experienced with tanks that are utilized to store various products including hazardous, nonhazardous chemicals, petrochemicals, petroleum and even food products like milk and grain. From municipal water storage tanks, to power plants, chemical processing plants, food production and fire protection.",
        services: [
          { title: "Tank Roof Cleaning", description: "Professional tank roof cleaning, sand blasting and coating services to maintain structural integrity and prevent corrosion." },
          { title: "Storage Tank Removal", description: "Aboveground Storage Tank (AST) and Underground Storage Tank (UST) removal services with proper disposal and environmental compliance." },
          { title: "Tank Maintenance & Inspection", description: "Comprehensive tank maintenance and inspection services to ensure optimal performance and regulatory compliance." },
          { title: "Vessel Cleaning", description: "Expert tank and vessel cleaning services during decommissioning and industrial renovations with specialized equipment and techniques." },
          { title: "Utility Cleaning", description: "Utility manhole and vault cleaning services for municipal water storage tanks, power plants, and industrial facilities." },
          { title: "Specialized Cleaning", description: "Cleaning services for finished product, waste water, chemical, silos, reservoirs, and septic tank systems." },
        ],
        benefits: [
    ...
    },
    {
      ...
      description: "Specialized online leak repair services for pipelines and equipment without interrupting operations, ensuring minimal downtime and maximum efficiency.",
      features: [
      ...
      detailedContent: {
        overview: "Calaya professionally undertakes online leak repair using the latest repair/sealing methodology in achieving the task. Our team of experienced professionals can seal online leaking points in valves, flanges and other critical equipment without interrupting operations, ensuring minimal downtime and maximum efficiency.",
        services: [
          { title: "Valve Leak Repair", description: "Professional online leak repair services for valves using the latest sealing methodology to ensure immediate and effective leak containment." },
          { title: "Flange Leak Repair", description: "Expert online repair services for flange leaks utilizing advanced sealing techniques while maintaining operational continuity." },
          { title: "Online Sealing Solutions", description: "Latest repair and sealing methodology applied by experienced professionals to seal leaking points in critical equipment and systems." },
          { title: "Emergency Leak Response", description: "Rapid response online leak repair services to minimize operational disruption and ensure safety compliance in emergency situations." },
        ],
        benefits: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100 max-w-3xl mx-auto">
              Comprehensive facilities management and maintenance services for industrial operations
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  {facilitiesCategories[activeTab].features.map((feature, index) => (
              ...
              >
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 lg:p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {facilitiesCategories[activeTab].detailedContent.benefits.map((benefit, index) => (
