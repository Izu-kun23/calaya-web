...
const wellIntervention2 = '/assets/well_services/well_intervention2.jpeg'
const wellIntervention3 = '/assets/well_services/well_intervention3.jpeg'
  ...
  return (
    <div className="interior-page min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden bg-blue-900 text-white py-12 sm:py-16 lg:py-20">
        <HeroBackdrop src="/assets/heroes/well-services-4k.jpg" alt="Well service operations at an energy facility" />
                          ...
                          >
                            <article className="gallery-hover-card relative overflow-hidden rounded-xl transition-all duration-300 transform hover:-translate-y-1">
                              <img
                                src={image.src}
                                alt={image.alt}
                                className={`w-full object-cover transition-[filter] duration-300 ${wellCompletionImages.length === 1 ? 'h-80 lg:h-96' : 'h-72'}`}
                                loading="lazy"
                          ...
                          >
                            <article className="gallery-hover-card relative overflow-hidden rounded-xl transition-all duration-300 transform hover:-translate-y-1">
                              <img
                                src={image.src}
                                alt={image.alt}
                                className={`w-full object-cover transition-[filter] duration-300 ${wellHeadMaintenanceImages.length === 1 ? 'h-80 lg:h-96' : 'h-72'}`}
                                loading="lazy"
                                onLoad={() => setIsLoading(false)}
                              />
            ...
            >
              ...
              <div className="w-full max-w-full">
                ...
                <div className="mt-3 xs:mt-4 text-center px-2">
                  <h3 id="modal-title" className="text-lg xs:text-xl font-semibold text-white mb-2">
                    {selectedImage.title}
                  </h3>
                  <p id="modal-description" className="text-gray-300 text-sm xs:text-base leading-relaxed">
