...
const addaxLogo = "/assets/clients/addax_logo.jpg";
const chevronLogo = "/assets/clients/chevron_logo.jpg";
const totalLogo = "/assets/clients/total_logo.png";
const oilservLogo = "/assets/clients/oilserv_logo.png";
const seepcoLogo = "/assets/clients/seepco_logo.png";
const nestoilLogo = "/assets/clients/nestoil_logo.jpg";
const erotonLogo = "/assets/clients/eroton_logo.jpg";
const oesLogo = "/assets/clients/oes_logo.jpg";
const enageedLogo = "/assets/clients/enageed_logo.jpg";
const orientalEnergyLogo = "/assets/clients/orientalenergy_logo.png";
const egbinLogo = "/assets/clients/egbin_logo.jpg";
const nddcLogo = "/assets/clients/nddc_logo.jpg";
const nigerianGasLogo = "/assets/clients/nigerian-gas_logo.jpg";
const saipemLogo = "/assets/clients/saipem.png";
const seplatLogo = "/assets/clients/seplat_logo.png";
const tenarisLogo = "/assets/clients/Tenaris_Logo.png";
const xwaveLogo = "/assets/clients/xwave_logo.png";
const platformLogo = "/assets/clients/platform_logo.png";
const marathonOilLogo = "/assets/clients/marathon-oil_logo.jpg";
const moniPuloLogo = "/assets/clients/moni_pulo_logo.jpg";
const nigerDeltaLogo = "/assets/clients/niger-delta_logo.jpg";
const heoslLogo = "/assets/clients/heosl_logo.jpg";
const juliusBergerLogo = "/assets/clients/julius-berger_logo.jpg";
const afrenLogo = "/assets/clients/afren_logo.jpg";
const amniLogo = "/assets/clients/amni_logo.jpg";
const belemaOilLogo = "/assets/clients/belemaoil_logo.jpg";
const eglngLogo = "/assets/clients/eglng_logo.jpg";
const exxonLogo = "/assets/clients/exxon_logo.jpg";
const forteOilLogo = "/assets/clients/forteoil_logo.jpg";
const energiaLogo = "/assets/clients/energia_logo.jpg";
const heirsOilGasLogo = "/assets/clients/heirs_oil_and_gas_logo.jpeg";
const rinaLogo = "/assets/clients/rina.png";
const dangoteLogo = "/assets/clients/Dangote_Group_Logo.svg.png";
const shellNigeriaLogo = "/assets/clients/Shell_nigeria.png";
const starzsLogo = "/assets/clients/starzs.png";
const nlngLogo = "/assets/clients/nlng.png";
const npdcLogo = "/assets/clients/npdc.jpg";
...
export default function ProjectsPage() {
  ...
  // Project data (full list preserved)
  const projectsData = [
  ...
  // Sort projects alphabetically by client
  projectsData.sort((a, b) => (a.client || "").localeCompare(b.client || ""));

  // Sort projects alphabetically by description
// projectsData.sort((a, b) => a.description.localeCompare(b.description));


  // Get unique clients for filter dropdown (alphabetically)
 const uniqueClients = useMemo(() => {
    const clients = [...new Set(projectsData.map((p) => p.client))];
    return ["All", ...clients.sort()];
  }, [projectsData]);

  // ✅ Filter, group by client, then sort inside each group alphabetically
  const filteredProjects = useMemo(() => {
    ...
    // ✅ Sort projects alphabetically within each client group
    Object.keys(grouped).forEach((client) => {
      grouped[client].sort((a, b) => a.description.localeCompare(b.description));
    });

    return grouped;
  }, [projectsData, searchTerm, selectedClient]);

  // Expand/Collapse Controls
  const toggleClient = (client) => {
    const newSet = new Set(expandedClients);
    if (newSet.has(client)) newSet.delete(client);
    else newSet.add(client);
    setExpandedClients(newSet);
  };

  const expandAll = () => setExpandedClients(new Set(Object.keys(filteredProjects)));
